...
class News {
  ...
  Future<void> getNews() async{
    ...
    var jsonData = jsonDecode(response.body); // decoding the data received

    if(jsonData['status'] == "ok"){
      jsonData["articles"].forEach((element){

        if(element['urlToImage'] != null && element['description'] != null){ // checking if news has image and description
